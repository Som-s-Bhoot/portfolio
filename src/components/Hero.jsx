...
export default function Hero() {
  ...
  return (
    <section ref={containerRef} className="relative min-h-screen bg-[#FAFAF7] flex items-center overflow-hidden pt-16">
      <div className="w-full max-w-[1280px] mx-auto px-6 md:px-16 relative z-10 flex items-center gap-0">
        {/* Content — left side */}
        ...
        <div
          ref={headshotRef}
          className="hidden md:flex flex-1 justify-end items-center pl-20"
        >
          <div className="w-[360px] h-[440px] rounded-3xl overflow-hidden relative shadow-[0_4px_40px_rgba(0,0,0,0.06)]">
            <img
              src="/headshot.png"
              alt="Som Chakravarty"
            ...
            <div
              ...
              style={{
                background: 'linear-gradient(135deg, rgba(212,165,116,0.08), transparent 60%)'
              }}
            />
          </div>
        </div>
