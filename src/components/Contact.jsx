  ...
  return (
    <section id="contact" ref={sectionRef} className="py-32 md:py-44 bg-surface relative overflow-hidden">
      <div className="relative w-full px-6 md:px-10 text-center">
        ...
        <h2 ref={titleRef} className="display-large text-ink mb-6">
          LET&apos;S TALK
        </h2>

        <p className="text-gray-500 text-base md:text-lg max-w-xl mx-auto leading-relaxed mb-12">
        ...
        <div ref={linksRef} className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          <a href="mailto:somnath686@gmail.com"
            className="inline-flex items-center gap-2 px-8 py-3.5 bg-black text-white text-sm font-semibold rounded-full hover:bg-gray-800 transition-colors tracking-wide"
            data-cursor-hover>
        ...
        <div ref={detailsRef} className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-2xl mx-auto">
          <div className="bg-white border border-gray-200 rounded-2xl p-4 shadow-sm">
            <p className="text-gray-400 text-[10px] tracking-[0.2em] uppercase mb-1">Location</p>
            <p className="text-gray-700 text-sm font-medium">Bangalore, India</p>
          </div>
          <div className="bg-white border border-gray-200 rounded-2xl p-4 shadow-sm">
            <p className="text-gray-400 text-[10px] tracking-[0.2em] uppercase mb-1">Availability</p>
            <p className="text-gray-900 text-sm font-semibold">Open to work</p>
          </div>
          <div className="bg-white border border-gray-200 rounded-2xl p-4 shadow-sm">
            <p className="text-gray-400 text-[10px] tracking-[0.2em] uppercase mb-1">Remote</p>
            <p className="text-gray-700 text-sm font-medium">Worldwide</p>
          </div>
          <div className="bg-white border border-gray-200 rounded-2xl p-4 shadow-sm">
            <p className="text-gray-400 text-[10px] tracking-[0.2em] uppercase mb-1">Timezone</p>
            <p className="text-gray-700 text-sm font-medium">IST (UTC+5:30)</p>
          </div>
        </div>
      </div>
    </section>
